...
/* note: you can give it a empty plotter and you can make it move without drawing */
/* plotData is essentially just a char. cast from void* to char* and then print it */
